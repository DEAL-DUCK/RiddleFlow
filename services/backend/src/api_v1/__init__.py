...
from .chat_groups.chat import ws as chat_group_router
from .chat_groups.pages import http as pages_router
...
router.include_router(router=chat_group_router, prefix="/ws")
